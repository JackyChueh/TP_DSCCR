                ...
                switch (req.GROUP_BY_DT)
                {
                    case "DETAIL":
                        for (int i = 9; i < 16; i++)
                        {
                            ...
                            {
                                fields += "CONVERT(DECIMAL(28,1),MSPCALARS" + i.ToString("00") + ") AS SEF" + i.ToString("00") + ",";
                            }
                        }
                        break;
                    case "YEAR":
                    ...
                    case "HOUR":
                        for (int i = 9; i < 16; i++)
                        {
                            ...
                            {
                                fields += "CONVERT(DECIMAL(28,1),AVG(MSPCALARS" + i.ToString("00") + ")) AS SEF" + i.ToString("00") + ",";
                            }
                        }
                        break;
                    default:
